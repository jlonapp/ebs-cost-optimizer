...
Thank you for your interest in contributing to this project. Whether it's a
...
When filing an issue, please check existing open and recently closed issues
...
labels (`enhancement`, `bug`, `duplicate`, `help wanted`, `invalid`,
`question`, `wontfix`), looking at any `help wanted` issues is a great place
to start.
